...
N 280 400 280 410 {lab=#net2}
N 280 420 280 430 {lab=GND}
...
value=1.8}
C {madvlsi/vsource.sym} -610 240 0 0 {name=Vout
value=0}
...
C {madvlsi/nmos3.sym} 280 370 2 0 {name=M1
L=\{len\}
W=\{wid\}
body=GND
nf=1
...
C {madvlsi/gnd.sym} 280 430 0 0 {name=l14 lab=GND}
C {madvlsi/ammeter1.sym} 280 410 0 0 {name=Vib}
