...
N 100 -40 180 -40 {lab=#net3}
N 0 -90 0 60 {lab=#net2}
N -60 60 -0 60 {lab=#net2}
N -60 40 -60 60 {lab=#net2}
N 100 40 100 60 {lab=#net4}
N -140 80 100 80 {lab=#net4}
N 100 60 100 80 {lab=#net4}
N -170 -40 -170 50 {lab=#net1}
N -170 -40 -60 -40 {lab=#net1}
N -60 60 -60 100 {lab=#net2}
N 100 80 100 100 {lab=#net4}
N -90 130 70 130 {lab=Vb}
N -440 -100 -440 -80 {lab=Vb}
N -480 -90 -440 -90 {lab=Vb}
N -480 -90 -480 -50 {lab=Vb}
N -480 -50 -470 -50 {lab=Vb}
N 180 -40 240 -40 {lab=#net3}
N -170 110 -170 170 {lab=#net5}
N -420 150 -420 180 {lab=Vdssat}
N -420 240 -420 260 {lab=#net6}
N -420 260 -380 260 {lab=#net6}
N -380 210 -380 260 {lab=#net6}
N -390 210 -380 210 {lab=#net6}
N -380 120 -380 210 {lab=#net6}
N -390 120 -380 120 {lab=#net6}
...
N 240 20 240 50 {lab=#net7}
N -60 190 -60 200 {lab=GND}
N -60 160 -60 180 {lab=#net8}
N 240 60 240 80 {lab=GND}
N -420 260 -420 280 {lab=#net6}
N -420 340 -420 350 {lab=#net9}
