...
C {current_divider.sym} -220 440 0 0 {name=x4}
...
C {madvlsi/resistor.sym} 180 210 0 0 {name=R1
value=1k
m=1}
C {madvlsi/gnd.sym} 180 240 0 0 {name=l4 lab=GND}
C {cascode_bias.sym} 90 510 0 0 {name=x5}
C {lab_pin.sym} 70 420 0 0 {name=p1 sig_type=std_logic lab=Vbp}
