...
C {madvlsi/pmos3.sym} 250 -50 2 0 {name=M1
L=\{len\}
W=\{wid\}
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} -50 -50 2 0 {name=M3
L=\{len\}
W=\{wid\}
body=VDD
nf=1
...
C {madvlsi/nmos3.sym} 250 40 2 0 {name=M5
L=\{len\}
W=\{wid\}
body=GND
nf=1
...
C {madvlsi/nmos3.sym} -50 40 2 0 {name=M7
L=\{len\}
W=\{wid\}
body=GND
nf=1
...
C {code_shown.sym} 340 0 0 0 {name=SPICE only_toplevel=false value=".param len=0.5 wid=3"}
