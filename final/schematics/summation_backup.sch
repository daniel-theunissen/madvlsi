...
C {lab_pin.sym} 410 80 2 0 {name=p3 sig_type=std_logic lab=Vbn}
...
C {madvlsi/ammeter1.sym} 230 -80 1 0 {name=VdI_n}
C {madvlsi/ammeter1.sym} 70 -80 3 0 {name=VdI_p}
