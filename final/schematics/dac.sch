...
C {daccell.sym} 165 5 0 0 {name=x4}
C {daccell.sym} 245 5 0 0 {name=x5}
C {daccell.sym} 325 5 0 0 {name=x6}
C {daccell.sym} 405 5 0 0 {name=x7}
C {daccell.sym} 485 5 0 0 {name=x8}
C {dacend.sym} 555 -12.5 0 0 {name=x9}
