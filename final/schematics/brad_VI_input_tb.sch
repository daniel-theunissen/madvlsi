...
N -990 -470 -930 -470 {lab=#net4}
N -990 -470 -990 -420 {lab=#net4}
N -620 -570 -590 -570 {lab=#net5}
N -620 -450 -590 -450 {lab=#net6}
...
C {/home/madvlsi/Documents/madvlsi/final/schematics/bias_gen/bias_gen.sym} -1360 -20 0 0 {name=x2}
...
C {lab_pin.sym} -930 -570 0 0 {name=p15 sig_type=std_logic lab=Vcn}
...
value=0.9}
C {madvlsi/resistor.sym} -960 -340 1 0 {name=R4
value=100k
m=1}
C {madvlsi/ammeter1.sym} -990 -410 2 0 {name=VIr1}
...
C {madvlsi/ammeter1.sym} -620 -570 1 0 {name=VIout_p1}
C {madvlsi/ammeter1.sym} -620 -450 1 0 {name=VIout_n1}
