...
N -320 -300 -260 -300 {lab=VP}
N -320 -260 -260 -260 {lab=VN}
...
C {iopin.sym} -320 -300 2 0 {name=p25 lab=VP}
C {lab_pin.sym} -260 -300 2 0 {name=p26 sig_type=std_logic lab=VP}
C {lab_pin.sym} 150 -300 1 0 {name=p1 sig_type=std_logic lab=VP}
C {lab_pin.sym} -20 -180 2 0 {name=p16 sig_type=std_logic lab=VP}
C {lab_pin.sym} 320 -180 0 0 {name=p21 sig_type=std_logic lab=VP}
C {iopin.sym} -320 -260 2 0 {name=p27 lab=VN}
C {lab_pin.sym} -20 -50 2 0 {name=p6 sig_type=std_logic lab=VP}
C {lab_pin.sym} 320 -50 0 0 {name=p28 sig_type=std_logic lab=VP}
C {lab_pin.sym} -260 -260 2 0 {name=p11 sig_type=std_logic lab=VN}
C {lab_pin.sym} -20 -120 2 0 {name=p5 sig_type=std_logic lab=VN}
C {lab_pin.sym} 320 -120 0 0 {name=p10 sig_type=std_logic lab=VN}
C {lab_pin.sym} -20 10 2 0 {name=p15 sig_type=std_logic lab=VN}
C {lab_pin.sym} 320 10 0 0 {name=p20 sig_type=std_logic lab=VN}
