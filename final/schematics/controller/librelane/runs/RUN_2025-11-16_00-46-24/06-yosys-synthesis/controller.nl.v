...
module controller(clk, comp, rst_n, dac_in, adc_out);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  sky130_fd_sc_hd__o21ai_2 _064_ (
    .A1(\count[1] ),
    .A2(\count[0] ),
    .B1(rst_n),
    .Y(_031_)
  ...
  sky130_fd_sc_hd__or4bb_2 _073_ (
    .A(\count[0] ),
    .B(\count[3] ),
    .C_N(\count[2] ),
    .D_N(\count[1] ),
  ...
  sky130_fd_sc_hd__or4bb_2 _076_ (
    .A(\count[1] ),
    .B(\count[3] ),
    .C_N(\count[2] ),
    .D_N(\count[0] ),
  ...
  sky130_fd_sc_hd__or4bb_2 _082_ (
    .A(\count[2] ),
    .B(\count[3] ),
    .C_N(\count[1] ),
    .D_N(\count[0] ),
